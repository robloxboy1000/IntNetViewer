...
namespace IntNetViewer {
	internal static class BrowserConfig {
		...
		public static string Branding = "IntNetViewer";
		...
		public static string InternalURL = "intnet";
		public static string DownloadsURL = "intnet://assets/downloads.html";
		public static string FileNotFoundURL = "intnet://assets/errors/notFound.html";
		public static string CannotConnectURL = "intnet://assets/errors/cannotConnect.html";
